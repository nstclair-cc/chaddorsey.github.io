  ...
  descriptions: [
    hasMouse ?
      {
        ...
        <p>The colors on the map are all the same because you haven’t dragged data onto the map yet.</p>
      </div>
      } :
    {
    },
    {
      ...
      feedback: <div>
            ...
            <p>Countries with a high value are darker and those with a low value are lighter. When you select a country, notice that the corresponding row highlights on the table. You can select lighter or darker portions of the map using the legend at the bottom.</p>
