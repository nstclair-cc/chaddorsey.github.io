      ...
      */
      ...
      switch (iNotification.values.operation) {
        case 'dataContextCountChanged':
          ...
          break;
        case 'create':
          if (iNotification.values.type === 'graph') this.handleAccomplishment('MakeGraph');else if (iNotification.values.type === 'caseTable') this.handleAccomplishment('MakeTable');
          break;
        case 'move':
