      ...
      */
      ...
      handleAttributeChange = function () {
        ...
        codapInterface.sendRequest({
          ...
          if (maxAttrsFound = 1) {
            ...
            if (attributeName === 'Average GNP per Person' && attributeAxis === 'horizontal') this.handleAccomplishment('AddAverageGNPHoriz');else if (attributeName === 'Average Life Expectancy' && attributeAxis === 'vertical') this.handleAccomplishment('AddAvgLifeExpectVertical');
          };
        }.bind(this));
      }.bind(this),
        ...
        if (iNotification.values.type === 'DG.MapModel' && iNotification.values.attributeName === 'Average GNP per Person') this.handleAccomplishment('AddGNPToMap');
      }.bind(this),
      ...
      switch (iNotification.values.operation) {
        ...
        case 'create':
          ...
          if (iNotification.values.type === 'map') this.handleAccomplishment('CreateMap');else if (iNotification.values.type === 'caseTable') this.handleAccomplishment('CreateTable');
          break;
        case 'move':
