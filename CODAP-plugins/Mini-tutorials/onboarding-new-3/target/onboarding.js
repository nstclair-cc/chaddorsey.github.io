      ...
      handleAttributeChange = function () {
        ...
        codapInterface.sendRequest({
          ...
          if (maxAttrsFound = 1) {
            ...
            if (attributeName === 'Total Count of Medical Doctors' && attributeAxis === 'horizontal') this.handleAccomplishment('AddDoctors');else if (attributeName === 'Region' && attributeAxis === 'vertical') this.handleAccomplishment('AddRegionVertical');
          };
        }.bind(this));
      }.bind(this),
